# Utility functions to convert between list and array representations of multi-fidelity data
# From Emukit: https://github.com/EmuKit/emukit/blob/main/emukit/multi_fidelity/convert_lists_to_array.py
